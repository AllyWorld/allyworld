...
<body>
<h3>${message}</h3>
	<spring:form action="login" modelAttribute="loginCreditials" method="GET">
            ...
            <div class="login">
                <div class="login-1">
                    <div class="email-login">
                        ...
                        <input data-validate-length-range="6"  required="required" class="el-2" type="email" name="email"/>               
                    </div>
    ...
    <spring:form action="register" modelAttribute="profile" method="POST">
    <section class="main-body">
        ...
        <div class="body-2">
            ...
            <div class="fr-2">
                <input type="text" placeholder="Email Id" name="login.email"/>
